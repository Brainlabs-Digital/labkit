<template>
    <lk-content>
        ...
        <p>The Checkbox Buttons component implements the <router-link to="/labkit/components/wrapper">Wrapper</router-link> component and has access to all of it's props. By default <code>margin-bottom</code> is set to <code>content</code>.</p>
        <h3>[TODO]</h3>
        <ul>
...
import Example from '@/labkit/documentation/components/examples/checkbox-buttons/Example';
