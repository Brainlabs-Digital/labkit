<template>
    <lk-content>
        <h1>Modal</h1>
        <p>The modal component (<code>lk-modal</code>)&hellip;</p>
...
import Example from '@/labkit/documentation/components/examples/modal/Example';
...
>
    ...
    <lk-panel-footer>
        <lk-button
            ...
            margin-bottom="none"
            outline
            @click.native="toggleModalIsVisible"
